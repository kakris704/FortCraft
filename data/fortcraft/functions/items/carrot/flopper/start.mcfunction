#> fortcraft:items/carrot/flopper/start
#
# 包帯の使用開始
#
# @within fortcraft:items/carrot/flopper/right_click

## タグ付け
    tag @s add FN.Consume
    tag @s add FN.Consume_Flopper

## スコア
    scoreboard players set @s FN.ConsumeTime 20
