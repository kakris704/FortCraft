...
## 移動
    ...
    #ダメージ
        execute as @e[dx=0,dy=0,dz=0] positioned ~-1 ~-1 ~-1 if entity @s[dx=0,dy=0,dz=0] at @s if predicate fortcraft:damage run function fortcraft:items/carrot/hammer_assault_rifle/bullet_hit
