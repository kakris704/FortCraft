...
## CMDを戻す
    ...
    execute if predicate fortcraft:sneak if score @s FN.Accuracy matches 2501.. run scoreboard players remove @s FN.Accuracy 200
    scoreboard players operation @s FN.Accuracy > $2500 FN.Constant