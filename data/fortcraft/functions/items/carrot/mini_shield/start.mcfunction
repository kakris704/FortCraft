#> fortcraft:items/carrot/mini_shield/start
#
# 包帯の使用開始
#
# @within fortcraft:items/carrot/mini_shield/right_click

## タグ付け
    tag @s add FN.Consume
    tag @s add FN.Consume_MiniShield

## スコア
    scoreboard players set @s FN.ConsumeTime 40
